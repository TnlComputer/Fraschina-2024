    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 text-gray-900">
          ...
          <form action="{{ route('AgendaGral.update', $agenda->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
              <label for="Nombre" class="form-label">Nombre</label>
              <input type="text" name="Nombre" id="Nombre" value="{{ $agenda->nombre }}" class="form-control" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="Direccion" id="Direccion" value="{{ $agenda->direccion }}" class="form-control">
            </div>
            <div class="mb-3">

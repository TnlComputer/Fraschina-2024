...
<div class="card">
  <div class="card-header">
    ...
    <a href="{{ route('representacion.show', $representacion->id) }}" class="btn btn-secondary float-right">Volver</a>
  </div>
  <div class="card-body">
    <form action="{{ route('representacion_personal.store') }}" method="POST">
      @csrf
